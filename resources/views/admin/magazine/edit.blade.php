...
<div class="magazine-card">
    ...
    <div class="card-header">
        <a href="{{route('admin.magazines.index')}}" style="color: white;">Data Majalah </a>\ Edit
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.magazines.update', $magazine->id) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="category" id="category"
                        ...
                        value="{{ old('category', $magazine->category) }}" placeholder="Fashion, Teknologi, dll">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="price" id="price" step="0.01"
                        ...
                        value="{{ old('price', $magazine->price) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="publication_year" id="publication_year"
                        ...
                        value="{{ old('publication_year', $magazine->publication_year) }}"
            ...
            <div class="mb-3">
                ...
                <select name="promo_id" id="promo_id" class="form-select @error('promo_id') is-invalid @enderror">
                    ...
                    @foreach($promos as $promo)
                        <option value="{{ $promo->id }}" {{ old('promo_id', $magazine->promo_id) == $promo->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                <label for="cover" class="form-label">Ganti Cover Majalah (kosongkan jika tidak ingin mengganti)</label>
                ...
                @if ($magazine->cover)
                    <div class="current-cover mt-3">
                        ...
                        <img src="{{ asset('storage/' . $magazine->cover) }}" alt="Cover saat ini" width="180">
                    </div>
                @endif
            </div>
